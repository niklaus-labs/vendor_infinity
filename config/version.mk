...
INFINITY_DISPLAY_VERSION := Project_Infinity-X-$(INFINITYVERSION)
...
ZIP_NAME := Project_Infinity-X-$(INFINITYVERSION)-$(INFINITY_BUILD)-$(INFINITY_BUILD_DATE)-VANILLA
ifeq ($(WITH_GAPPS), true)
ZIP_NAME := Project_Infinity-X-$(INFINITYVERSION)-$(INFINITY_BUILD)-$(INFINITY_BUILD_DATE)-GAPPS
endif
